...
COMMANDS ?=  TOP_10 TOP_100 TOP_1000 COUNT TOP_100_FILTER_5% TOP_100_FILTER_20% TOP_100_FILTER_80% COUNT_FILTER_5% COUNT_FILTER_20% COUNT_FILTER_80%
...
#ENGINES ?= turbopuffer
#ENGINES ?= tantivy-0.26 lucene-10.4.0
ENGINES ?= turbopuffer tantivy-0.26 lucene-10.4.0
PORT ?= 8080
